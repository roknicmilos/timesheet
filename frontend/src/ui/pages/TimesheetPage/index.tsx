...
function TimesheetPage() {
    ...
    useEffect(() => {
        ...
        getTimesheetMonth(user.id, currentMonth, currentYear).then((timesheetMonth) =>
    ...
    const handleNextMonth = useCallback(() => {
        ...
        getTimesheetMonth(user!.id, nextMonth, nextYear).then((timesheetMonth) => setTimesheetMonth(timesheetMonth));
    ...
    const handlePreviousMonth = useCallback(() => {
        ...
        getTimesheetMonth(user!.id, previousMonth, previousYear).then((timesheetMonth) =>
            setTimesheetMonth(timesheetMonth)
        );
    }, [user, currentMonth, currentYear]);
            ...
            <section className="content">
                <div className="main-content">
                    ...
                    <div className="table-navigation">
                        <p className="table-navigation__prev" onClick={handlePreviousMonth}>
                            <span>previous month</span>
                        </p>
                        <span className="table-navigation__center">
                            {timesheetMonth?.label}, {timesheetMonth?.year}
                        </span>
                        <p className="table-navigation__next" onClick={handleNextMonth}>
                    ...
                    <div className="table-wrapper">
                        <table className="month-table">
                            ...
                            <tbody>
                                {timesheetMonth?.weeks?.map((timesheetWeek) => (
                                    <CalendarWeek key={timesheetWeek.order} timesheetWeek={timesheetWeek} />
                                ))}
                            </tbody>
                        </table>
                    </div>
    ...
    return timesheetMonth ? <PageContent /> : <Spinner />;
}
